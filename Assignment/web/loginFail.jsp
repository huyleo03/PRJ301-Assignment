...
<head>
    ...
    <style>
        ...
        .login-container {
            display: flex;
            flex-direction: column; /* S?p x?p các ph?n t? theo chi?u d?c */
        ...
        .error-message {
            ...
            font-weight: bold;
            margin-bottom: 10px;
            text-align: center; /* C?n gi?a v?n b?n */
        }
        .login-input {
            width: 100%;
            padding: 10px;
...
<body>
    <div class="wrapper">
        <div class="login-container">
            ...
            <form action="loginfail" method="post">
                ...
                <div class="remember-section">
                    ...
                    <label for="remember-checkbox">Remember on this computer.</label>
                </div>
