...
public class AttendanceReportServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        AttendanceReportDBContext dal = new AttendanceReportDBContext();
        List<StudentAttendance> attendanceReportList = dal.getAttendanceReport(groupId);
        request.setAttribute("attendanceReportList", attendanceReportList);
